...
const Schedule = () => {
    ...
    piketGroup = [
        ["Ajeng", "Andini", "Arul", "Dimas", "Elvira"],
        ["Faris A", "Faris F", "Fayza", "Fergie", "Ghina U"],
        ["Gina K", "Githsa", "Hanifa", "Hilman", "Kelvin"],
        ["Lala", "Lia", "Lulu", "Geby", "Marsya", "Rizik"],
        ["Damar", "Juan", "Naufal A", "Naufal R", "Naysila"],
        ["Nazwa", "Ridho", "Irfan"],
    ]
